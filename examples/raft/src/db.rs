        ...
        match cmd.tp {
            CommandType::Create(key) => {
                if self.data.contains_key(&key) {
                    ...
                    self.data.insert(key, Default::default());
...
mod tests {
    ...
    fn basic() {
        ...
        let rep1 = db.apply_command(Command::new(CommandType::Create("k1".to_owned()), (0, 0)));
        assert_eq!(rep1.status, 201);
        
        let rep2 = db.apply_command(Command::new(CommandType::Update("k1".to_owned(), "v1".to_owned()), (0, 1)));
        ...
        let rep3 = db.apply_command(Command::new(CommandType::Delete("k1".to_owned()), (0, 2)));
        assert_eq!(rep3.status, 204);

        let res2 = db.read_value(&"k1".to_owned());
        assert!(res2.is_none());

        let rep4 = db.apply_command(Command::new(CommandType::Delete("k1".to_owned()), (0, 3)));
    ...
    fn creates_empty() {
        ...
        let rep = db.apply_command(Command::new(CommandType::Create("k1".to_owned()), (0, 0)));
    ...
    fn create_twice() {
        ...
        let rep2 = db.apply_command(Command::new(CommandType::Create("k1".to_owned()), (0, 1)));
    ...
    fn update_works() {
        ...
        let rep3 = db.apply_command(Command::new(CommandType::Update("k1".to_owned(), "v2".to_owned()), (0, 2)));
